System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  function makeBox(parent, name, w, h, x, y, col, anchorX, anchorY) {
    if (anchorX === void 0) {
      anchorX = 0.5;
    }
  ...
  function makeContainer(parent, name, x, y, anchorX, anchorY) {
    ...
    var outlineNode = new Node('_outline');
    n.addChild(outlineNode);
    var outlineUit = outlineNode.addComponent(UITransform);
    outlineUit.setContentSize(0, 0);
    var g = outlineNode.addComponent(Graphics);
    return {
      node: n,
      outline: g
    };
    ...
    execute: function () {
      ...
      _export("AutoFitContainerTest", AutoFitContainerTest = (_dec = ccclass('AutoFitContainerTest'), _dec(_class = class AutoFitContainerTest extends Component {
        ...
        _buildCase2() {
          ...
          var moving = makeBox(c, 'Moving', 50, 50, 0, 0, new Color(255, 100, 100, 200));
        ...
        _buildCase3() {
          ...
          var toggled = makeBox(c, 'Toggle', 60, 60, 120, 80, new Color(255, 160, 0, 200));
        ...
        _buildCase4() {
          // 父节点挂 Layout
          var layoutParent = makeNode(this.node, 'LayoutParent');
          layoutParent.setPosition(0, -150, 0);
          var lpUit = layoutParent.getComponent(UITransform);
          lpUit.setContentSize(600, 200);
          var layout = layoutParent.addComponent(Layout);
          layout.type = Layout.Type.HORIZONTAL;
          layout.spacingX = 20;
          layout.paddingLeft = 10;
          layout.paddingBottom = 10;
          layout.resizeMode = Layout.ResizeMode.CONTAINER;
          var sizes = [[40, 40], [80, 60], [30, 90]];
          var colors = [new Color(255, 160, 160, 200), new Color(160, 255, 160, 200), new Color(160, 160, 255, 200)];
